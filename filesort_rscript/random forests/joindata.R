...
getwd()
setwd("/home/yimr/R/data/demo_data/") 
...
transactions <- read.table(file="./rf_rhadoop_demo/Train.csv",
                           header=TRUE,
                           sep=",",
                           quote="\"",
                           row.names=1,
...
machines <- read.table(file="./rf_rhadoop_demo/Machine_Appendix.csv",
                       header=TRUE,
                       sep=",",
                       quote="\"",
                       fill=TRUE,
...
write.table(x=training.data,
            file="./rf_rhadoop_demo/training.csv",
            sep=",",
            quote=TRUE,
            row.names=FALSE,
            eol="\n",
