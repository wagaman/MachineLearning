...
#cd /home/yimr/R/RScript
#Rscript filesort_inout_3args_mergetxt.R "/home/yimr/R/data/train/" "../test/" "/home/yimr/R/data/output/"
#getwd()
...
#length(test)
table(train$type)
write.csv(train,file = "/home/yimr/R/data/output/train.csv")
